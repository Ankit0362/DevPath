...
import { dsaResourcesByLanguage } from "../data/pathwayResources";
...
export const DSAPage = () => {
  ...
  return (
    <PageLayout
      ...
      subtitle="Your roadmap to acing technical interviews."
    >
      ...
      {activeTab === "english" && (
        <Section title="English Resources" color="cyan">
          {dsaResourcesByLanguage.english.map((item) => (
      ...
      {activeTab === "hindi" && (
        <Section title="Hindi Resources" color="orange">
          {dsaResourcesByLanguage.hindi.map((item) => (
            <ResourceCard key={item.title} {...item} />
          ))}
        </Section>
      )}
